...
<html lang="en">
  ...
  <body>
     ...
     <main class="container">
        ...
        <h1>Escolas</h1>
        <a href="/escola/inserir" class="btn btn-primary">Nova Escola</a>
                ...
                <?php 
                 ...
                 ?> 
                    <tr>
                        ...
                        <td><?= $c['cnpj']?></td>
                        <td>
                            <a href="/escola/alterar/id/<?= $c["id"]?>" class="btn btn-warning">Alterar</a>
                            <a href="/escola/excluir/id/<?= $c["id"]?>" class="btn btn-danger">Excluir</a>
                        </td>
                    </tr>
                <?php
                    }

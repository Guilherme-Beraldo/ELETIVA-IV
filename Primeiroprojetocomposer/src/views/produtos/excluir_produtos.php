        ...
        <form action="/produtos/deletar" method="post">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="text" name="preco" class="form-control" disabled value="<?= $resultado['preco'] ?>">
                    <label for="descricao" class="form-label">Descrição</label>
                    <input type="text" name="descricao" class="form-control" disabled value="<?= $resultado['descricao'] ?>">
              </div>
            <div class="row">
                <div class="col">

...
<html lang="en">
  ...
  <body>
     ...
     <main class="container">
        ...
        <h1>Veiculos</h1>
        <a href="/veiculo/inserir" class="btn btn-primary">Novo Veiculo</a>
                ...
                <?php 
                 ...
                 ?> 
                    <tr>
                        ...
                        <td><?= $c['tipo']?></td>
                        <td>
                            <a href="/veiculo/alterar/id/<?= $c["id"]?>" class="btn btn-warning">Alterar</a>
                            <a href="/veiculo/excluir/id/<?= $c["id"]?>" class="btn btn-danger">Excluir</a>
                        </td>
                    </tr>
                <?php
                    }
